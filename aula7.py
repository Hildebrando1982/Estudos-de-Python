# Variáveis são dados de entrada que deve ser usadas para salvar algo na memória do computador.
# PEP8: inicie as variáveis com letras minúsculas, pode usar números e underline _.
# O sinal de '=' é usado o operador de atribuição e não igual em operação aritmética. 
